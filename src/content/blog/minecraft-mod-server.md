...
入れたいModが決まっているならそのMod側の対応ローダーに合わせます。特にこだわりがなければ、軽くてトラブルの少ないFabricから始めるのがおすすめです。Createや工業系の大型Modで遊びたい場合はForge向けが多いので、その場合は[Forgeサーバーの立て方](/blog/minecraft-forge-server/)を参照してください。
